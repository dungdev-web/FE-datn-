...
const defaultProducts: IProduct[] = [
  {
    ...
    images: [
      ...
      {
        images_id: 104,
        url: "/images/products/chaybo/NikeAirMax97SE(xanhlam).webp",
        alt_text: "Converse Run Star Motion bên hông",
        type: "gallery",
      },
    ],
    ...
    product_variants: [
      {
        ...
        color: {
          ...
          code_color: "#00FF00",
          name_color: "Xanh lá",
          images: "/images/products/chaybo/NikePegasus39.webp",
        },
    ...
    product_variants: [
      {
        ...
        color: {
          ...
          images: "/images/products/chaybo/Ultraboost22.webp",
        },
    ...
    product_variants: [
      {
        ...
        color: {
          ...
          code_color: "#FF0000",
          name_color: "Đỏ",
          images: "/images/products/chaybo/PumaVelocityNitro2.webp",
        },
