...
export default function Product(){
    ...
    return(
        ...
        style={{backgroundImage: "url(//bizweb.dktcdn.net/100/505/077/themes/934930/assets/section_breadcrumb.jpg?1730865096645)", backgroundPosition: "center"}}
        >
            ...
            <div className="wrapper">
              <div className="col-lg-3">
                ...
                <div className="aside-filter">
                  <div className="aside-title">
                    <h2 className="title-head margin-top-0"><span>Bộ lọc</span></h2>
                  </div>
              ...
              <div
                className="main_container collection col-lg-9 col-md-9 col-md-push-3 col-lg-push-3"
              >
                <div className="category-products products">
                  <div className="sortPagiBar">
                    <div className="row">
                      <div className="col-xs-5 col-md-6 col-sm-6">
                        <div className="hidden-xs">
                          <a href="javascript:;" data-view="grid">
                            <span
                              className="btn button-view-mode view-mode-grid active"
                            >
                              <i className="fa fa-th" aria-hidden="true"></i>
                            </span>
                          </a>
                          <a href="javascript:;" data-view="list">
                            <span className="btn button-view-mode view-mode-list">
                      ...
                      <div
                        className="col-xs-12 col-md-6 col-sm-6 text-xs-left text-sm-right"
                      >
                        <div id="sort-by">
                          ...
                          <ul>
                            <li>
                              ...
                              <ul className="ul_2">
                                ...
                                <li>
                                  <a
                                    href="javascript:;">Z → A</a>
                                </li>
                                <li>
                                  <a
                                    href="javascript:;">Giá tăng dần</a>
                                </li>
                                <li>
                                  <a
                                    href="javascript:;">Giá giảm dần</a>
                                </li>
                                <li>
                                  <a
                                    href="javascript:;">Hàng mới nhất</a>
                                </li>
                                <li>
                                  <a
                                    href="javascript:;">Hàng cũ nhất</a>
                                </li>
                              </ul>
                            </li>
                          </ul>
                    ...
                    <div className="product-card" style={{width: "238px"}}>
                      <div className="product-image">
                        ...
                        <div className="product-price">
                          <span className="old-price"><del>1.500.000đ</del></span>
        ...
        <aside className="aside-item collection-category">
          ...
          <div className="categories-box">
            <ul className="lv1">
              ...
              <li className="nav-item nav-items active">
                <a href="/collections/all" className="nav-link" title="Sản phẩm">
                  Sản phẩm
                </a>
              </li>
              <li className="nav-item nav-items">
