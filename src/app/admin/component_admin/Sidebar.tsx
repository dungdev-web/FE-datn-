      ...
      <ul className="menu">
        ...
        >
          <Link
            ...
            className={`flex items-center ${
              pathname === "/admin/categories" ? "tick" : ""
            }`}
        ...
        <li
          className={`has-submenu ${
            openMenuKey === "danhmucbaiviet" ? "open" : ""
          }`}
        >
          <Link
            href={"/admin/categories_post"}
            className={`flex items-center ${
              pathname === "/admin/categories_post" ? "tick" : ""
            }`}
          ...
          {!isCollapsed && (
            <ul className="submenu">
              <li>
                <Link href={"/admin/categories_post"}>
                  Danh sách danh mục bài viết
                </Link>
              </li>
              <li>
                <Link href={"/admin/categories_post/add"}>
        ...
        >
          ...
          {!isCollapsed && (
            <ul className="submenu">
              <li>
                <Link href={"/admin/blog"}>Danh sách bài viết</Link>
              </li>
              <li>
                <Link href={"/admin/blog/add"}>Thêm mới bài viết</Link>
              </li>
            </ul>
          )}
        </li>
