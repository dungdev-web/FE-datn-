        ...
        <main className="main-content">
            <div className="category-list">
                ...
                <div className="actions">
                    <Link href={'/admin/categories/add'} className="btn btn-add"><i className="fa-solid fa-plus"></i> Thêm mới danh mục</Link>
                ...
                <table className="category-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td></td>
                            <td>
                                 <Link href={'/admin/categories/edit'}> <i className="fa-solid fa-pen edit-icon" title="Sửa mã"></i></Link>
