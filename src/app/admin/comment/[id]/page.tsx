...
import { getByIdReview, setStatusReview } from "@/services/productService";
...
export default function CommentDetailPage() {
  ...
  const handleToggleStatus = async () => {
    ...
    try {
      setUpdating(true);
      await setStatusReview(comment.product_reviews_id, newStatus);
      setComment({ ...comment, status: newStatus });
    } catch (err) {
