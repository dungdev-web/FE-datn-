                ...
                <div className="form-group">
                  ...
                  <div className="dropdown-multiselect" id="danh-muc-wrapper">
                    ...
                    <div className="dropdown-options" id="dropdown-options">
                      <label>
                        <input type="checkbox" defaultValue="Giày Nam" /> Giày
                        Nam
                      </label>
                      <label>
                      ...
                      <label>
                        <input type="checkbox" defaultValue="Giày Trẻ em" />{" "}
                        Giày Trẻ em
                      </label>
                      <label>
                      ...
                      <label>
                        <input type="checkbox" defaultValue="Thể thao" /> Thể
                        thao
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="custom-select">
                    ...
                    <div className="dropdown">
                      ...
                      <div
                        ...
                        style={
                          { "--color": "lightgray" } as React.CSSProperties
                        }
                      >
                        <span className="color-circle"></span>
                      ...
                      <div
                        ...
                        style={
                          { "--color": "darkorange" } as React.CSSProperties
                        }
                      >
                        <span className="color-circle"></span>
                      ...
                      <div
                        ...
                        style={
                          { "--color": "chocolate" } as React.CSSProperties
                        }
                      >
                        <span className="color-circle"></span>
